...
class CarrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create carro" do
    assert_difference('Carro.count') do
      post carros_url, params: { carro: { marca: @carro.marca, modelo: @carro.modelo, nome: @carro.nome } }
    end
  ...
  test "should update carro" do
    patch carro_url(@carro), params: { carro: { marca: @carro.marca, modelo: @carro.modelo, nome: @carro.nome } }
